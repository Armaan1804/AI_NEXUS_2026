...
import { eventData as staticEventData, judges as staticJudges, leaderboard as staticLeaderboard, schedule as staticSchedule } from './staticData.js';
...
function App() {
  const [eventData, setEventData] = useState(staticEventData);
  ...
  // Data is now purely static and hardcoded. 
